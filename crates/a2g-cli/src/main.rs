...
// cmd_* functions in this file have many parameters by design (one per CLI flag).
#![allow(clippy::too_many_arguments)]
// CLI wiring: callers pass &PathBuf from clap, no benefit to generic &Path here.
...
// Re-export a2g-core modules under their original names so command
// implementations below compile without changes.
use a2g_core::authority;
use a2g_core::enforce;
use a2g_core::identity;
use a2g_core::mandate;
use a2g_core::proposal;
use a2g_core::receipt;
